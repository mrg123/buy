...
<div class="container">
  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      <h2 style="text-align:center"><?php echo $heading_title; ?> <span style="color:#b0b0b0"><?php echo $heading_title_tip; ?></span></h2>
                ...
                if(docHeight<scrollHeight && flag == true && stop){
                        $.ajax({
                            ...
                            success: function(json) {
                                if (json['error']){
									var _html = '';
									_html += '<div class="product-layout product-grid col-lg-3 col-md-3 col-sm-6 col-xs-12">';
									//_html += '<center><b>Empty</b></center>';
									_html += '</div>';
